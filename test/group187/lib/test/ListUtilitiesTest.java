...
public class ListUtilitiesTest {
	...
	public static void main(String[] args) {
		...
		// TEST getCustomerListFromSequentialFile
			try {
				File allCustomers = new File("/HotelReservationSystem/datafiles/unsorted/customers/AllCustomers.txt");
					...
					try{
						//create list per customer text file
							Customer[] customerArray = HotelFileLoader.getCustomerListFromSequentialFile(
									new File("/HotelReservationSystem/datafiles/unsorted/customers/" + count + ".txt"));
